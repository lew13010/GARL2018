...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $teams = $em->getRepository('AppBundle:Team')->getGamersWithRank();
        /*
        foreach ($teams as $team) {
            var_dump($team->getGamers()->getSnapshot()[0]->getRank()->getTier()->getTierName());
            die;
        }
        */
        return $this->render('@App/team/index.html.twig', array(
            'teams' => $teams,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('@App/team/new.html.twig', array(
            'team' => $team,
    ...
    public function showAction(Team $team)
    {
        ...
        return $this->render('@App/team/show.html.twig', array(
            'team' => $team,
    ...
    public function editAction(Request $request, Team $team)
    {
        ...
        return $this->render('@App/team/edit.html.twig', array(
            'team' => $team,
